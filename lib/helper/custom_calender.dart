...
class WeeklyDatePickerr extends StatefulWidget {
  WeeklyDatePickerr({
    Key? key,
  ...
  @override
  _WeeklyDatePickerrState createState() => _WeeklyDatePickerrState();
}

class _WeeklyDatePickerrState extends State<WeeklyDatePickerr> {
